...
const buttonClasses = cva(
  "w-full flex flex-row justify-center items-center text-center whitespace-nowrap sm:w-fit sm:px-8 py-3 text-lg rounded-lg disabled:cursor-not-allowed disabled:opacity-50 focus:scale-95 transition-transform",
  {
    variants: {
      variant: {
        primary: [
