    ...
    <nav className="bg-white shadow">
      <div className="container mx-auto px-4 py-3">
        <div className="flex justify-between items-center">
          <Link href="/">
            <span className="text-gray-800 text-xl font-bold hover:text-gray-700 cursor-pointer">
              Your Logo
            </span>
          </Link>
          ...
          <div className="relative">
            ...
            <div
              ...
              onMouseEnter={(e) =>
                e.currentTarget.classList.remove("invisible", "opacity-0")
              }
              aria-label="submenu"
            >
              <Link href="/connect-kit">ConnectKit</Link>
